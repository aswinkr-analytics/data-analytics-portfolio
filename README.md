# Data Analytics Portfolio | Aswin K.R
...
├── README.md (this file)
├── 1_Healthcare_Analytics/
│   ├── README.md
│   ├── data/
│   │   └── healthcare_Analysis.xlsx
│   ├── analysis/
│   │   └── healthcare_analysis.ipynb
│   └── visualizations/
│       └── healthcare_dashboard.pbix
│
├── 2_Retail_Sales_Analytics/
│   ├── README.md
│   ├── data/
│   │   └── retail_sales_dataset-1.xlsx
│   ├── analysis/
│   │   └── retail_analysis.ipynb
│   └── visualizations/
│       └── retail_dashboard.pbix
│
├── 3_Finance_Stocks_Analytics/
│   ├── README.md
│   ├── data/
│   │   └── Finance_Stocks.xlsx
│   ├── analysis/
...
I'm excited about opportunities to apply these data analytics skills in a professional setting. Feel free to reach out with questions, collaboration ideas, or job opportunities!

**Contact Information:**
- 📧 Email: aswinkr.work@gmail.com
- 📱 WhatsApp/Phone: +91 8943698229
- 🔗 LinkedIn: [aswinkr](https://linkedin.com/in/aswinkr)
- 💻 GitHub: [@aswinkr-analytics](https://github.com/aswinkr-analytics)
...
*Driven by curiosity, powered by data, guided by impact.*
